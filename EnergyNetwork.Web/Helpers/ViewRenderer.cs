    ...
    public class ViewRenderer
    {
        ...
        public ViewRenderer(ControllerContext controllerContext = null)
        {
            if (controllerContext == null)
            {
                ...
                {
                    controllerContext = CreateController<EmptyController>().
                        ControllerContext;
                }
                else
                {
        ...
        {
            return RenderViewToStringInternal(viewPath,
                model,
                false);
        }
        ...
        public static string RenderView(string viewPath, object model = null, ControllerContext controllerContext = null)
        {
            ...
            return renderer.RenderViewToString(viewPath,
                model);
        }
        ...
        {
            var renderer = new ViewRenderer(controllerContext);
            return renderer.RenderPartialViewToString(viewPath,
                model);
        }
        ...
        protected string RenderViewToStringInternal(string viewPath, object model, bool partial)
        {
            // first find the ViewEngine for this view
            ViewEngineResult viewEngineResult = null;
            if (partial)
            {
                viewEngineResult = ViewEngines.Engines.FindPartialView(Context,
                    viewPath);
            }
            else
            {
                viewEngineResult = ViewEngines.Engines.FindView(Context,
                    viewPath,
                    null);
            }
