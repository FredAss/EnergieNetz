...
namespace EnergyNetwork.Web.SEO
{
    ...
    public class Snapshot: ISnapshot
    {
        ...
        {
            if (ConfigurationManager.AppSettings["CrawlerServiceApiId"] != "{CrawlerServiceApiId}" && ConfigurationManager.AppSettings["CrawlerServiceEndPoint"] != "{CrawlerServiceEndPoint}" && ConfigurationManager.AppSettings["CrawlerServiceApplication"] != "{CrawlerServiceApplication}")
            {
                return true;
            }
            return false;
        ...
        public async Task<string> Get(string url, string userAgent)
        {
            ...
            var response = await client.PostAsJsonAsync<CrawlerConfig>(ConfigurationManager.AppSettings["CrawlerServiceEndPoint"],
                config);
